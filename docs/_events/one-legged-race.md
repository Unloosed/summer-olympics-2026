...
description: |
  A race where participants hop on one leg, sometimes while balancing a ball on their palm to deliver to a basket. This event tests balance and coordination.
ruleset: |
