...
- `docs/`: Contains the core content and documentation for the games.
  - `index.html`: The landing page for GitHub Pages.
  - `summer_olympics_2026.md`: Detailed official charter, rules, and event categories.
...
To view the hosted site, visit the GitHub Pages URL associated with this repository (typically `https://<username>.github.io/<repo-name>/`).
